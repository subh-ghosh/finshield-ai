...
**Agent Roles:**
1. **Supervisor Agent:** Parses the user's intent, extracts entities, and coordinates the execution flow.
2. **Rule Intelligence Agent:** Evaluates exactly which deterministic thresholds were breached.
3. **ML Insights Agent:** Translates the statistical output of the Isolation Forest into natural language.
4. **Network Analysis Agent:** Evaluates 2nd and 3rd-degree counterparty risks.
